...
public class ChatRightText extends TextView {
    ...
    public ChatRightText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChatRightText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private int PaddingT = paintWidth + 10, PaddingB = paintWidth + 10,
            PaddingL = paintWidth + 20, PaddingR = paintWidth + 20 + triangleH;
