 ...
 */
public class MyNestedScrollParent5 extends LinearLayout implements NestedScrollingParent {
    public MyNestedScrollParent5(Context context) {
        super(context);
    }

    public MyNestedScrollParent5(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private MyNestedScrollChild5 myNestedScrollChild;
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        ...
        if (target instanceof MyNestedScrollChild5) {
            myNestedScrollChild = (MyNestedScrollChild5) target;
            result = true;
        }
