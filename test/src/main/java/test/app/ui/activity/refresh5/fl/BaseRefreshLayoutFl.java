 ...
 */
public class BaseRefreshLayoutFl extends FrameLayout implements NestedScrollingChild, NestedScrollingParent {
    public BaseRefreshLayoutFl(Context context) {
        super(context);
    }

    public BaseRefreshLayoutFl(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
