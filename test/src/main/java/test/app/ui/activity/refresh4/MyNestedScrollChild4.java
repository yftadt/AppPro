...
public class MyNestedScrollChild4 extends LinearLayout implements NestedScrollingChild {
    ...
    public MyNestedScrollChild4(Context context) {
        super(context);
    }

    public MyNestedScrollChild4(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                MyNestedScrollParent4 parent = (MyNestedScrollParent4) getParent();
                parent.pointerUp();
                break;
        }
